...
# Preload PKI
vault write pki/config/ca pem_bundle=@/data/ca-bundle.pem
vault write pki/roles/localhost issuer_ref=default allow_localhost=true allow_any_name=true client_flag=true ttl=87600h