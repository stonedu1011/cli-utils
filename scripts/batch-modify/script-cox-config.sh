...
# ./deviceservice --> "deviceservice 1.32.4-SNAPSHOT"
# ./channelmapservice --> "channelmapservice 1.32.1-SNAPSHOT"
# ./contentservice --> "contentservice 1.32.3-SNAPSHOT"
# ./mobileactivationservice --> "mobileactivationservice 1.32.5-SNAPSHOT"
...
# ./platformservices --> "platformservices 1.32.2-SNAPSHOT" # No Config
...
customized-commit-message() {
  echo "US21129 - Part 2 Config file cleanup & remove redundant cox/mso config"
}
